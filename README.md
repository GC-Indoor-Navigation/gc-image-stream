...
STREAM_RELAY_CREDENTIAL_ENABLED=false
STREAM_RELAY_CREDENTIAL_URL_TEMPLATE=http://gc-main-server:8080/internal/v1/tenants/{tenant_id}/processing-jobs/{processing_job_id}/relay-credentials
STREAM_RELAY_CREDENTIAL_AUDIENCE=gc-processing-relay
STREAM_RELAY_CREDENTIAL_HTTP_TIMEOUT_SEC=2
STREAM_WORKLOAD_TOKEN_URL=http://keycloak:8080/realms/geocapstone/protocol/openid-connect/token
STREAM_WORKLOAD_CLIENT_ID=gc-image-stream
STREAM_WORKLOAD_CLIENT_SECRET=
STREAM_WORKLOAD_SCOPE=
STREAM_SESSION_AUTH_ENABLED=false
STREAM_CAMERA_INGEST_AUTH_ENABLED=false
STREAM_SESSION_JWKS_URL=http://gc-main-server:8080/.well-known/jwks.json
STREAM_SESSION_TOKEN_ISSUER=https://main-server.geocapstone.internal
STREAM_SESSION_TOKEN_AUDIENCE=gc-data-plane
STREAM_CAMERA_INGEST_TOKEN_AUDIENCE=gc-stream-ingest
STREAM_SESSION_STATUS_URL_TEMPLATE=http://gc-main-server:8080/.well-known/session-status/{processing_job_id}
